...
X = data[['day_of_the_week', 'verified', 'user_followers_count', 'user_friends_count', 'user_favourites_count', 'user_statuses_count']]
y = data['likes']
...
predictors = [['LinearRegression', lr], ['DecisionTreeClassifier', dt], ['SVM', svm], ['Random Forest Classifier', rfc], ['XGB Classifier', xgb_imb_aware]]
